...
export const API_CATEGORY_PRODUCT = `http://${IP_ADDRESS}/api-theloai`;

// api products

export const API_PRODUCT = `http://${IP_ADDRESS}/api-sanpham`;

export const API_PRODUCT_TOP8 = `http://${IP_ADDRESS}/api-sanpham/top8`;

export const API_COLOR_PRODUCT = `http://${IP_ADDRESS}/api-mausanpham`;

// api product love


export const API_GET_TO_LOVE = `http://${IP_ADDRESS}/api-sanpham/SPL`;
...
export const API_PRODUCT_ORDER = `http://${IP_ADDRESS}/api-sanpham/SPD`;
